...
\usepackage{environ} % until we get rid of the confused notes
...
\def\columnsep{\pgfmatrixcolumnsep}
...
%\tikzset{/tikz/cdots/.style={edge node={\node[every label,/tikz/commutative diagrams/.cd]{$\cdot\,\cdot\,\cdot$}}}}
...
\NewEnviron{ConfusedNote}{\begin{center}\scalebox{0.5}{\begin{minipage}{\textwidth}\begin{framed}\BODY\end{framed}\end{minipage}}\end{center}}
...
\makesymbdefs{bb}{\mathbb}{\upperalphabet}                      % \A -> \mathbb{A}
\makesymbdefs{cal}{\mathcal}{\upperalphabet}                  % \Acal -> \mathcal{A}
\makesymbdefs{cat}{\mathsf}{\upperalphabet}                  % \Acal -> \mathsf{A}
\makesymbdefs{frak}{\mathfrak}{\loweralphabet}                % \afrak -> \mathfrak{a}
\makesymbdefs{rm}{\mathrm}{\upperalphabet\loweralphabet}                % \afrak -> \mathfrak{a}
...
\makesymbdefs{pt}{\pt}{\upperalphabet}                  % \Acal -> A_+

\def\Id{\mathrm{Id}}

\def\newcohomologytheory#1#2{%
    \@xp\def\csname#1\endcsname{#2}%
    \@xp\def\csname#1twee\endcsname{\widetilde{\csname#1\endcsname}\vphantom{#2}}%
}

\newcohomologytheory{H}{H}
\newcohomologytheory{K}{K}
\newcohomologytheory{J}{J}
\newcohomologytheory{KO}{KO}
\newcohomologytheory{Sph}{Sph}
...
\def\otimeshat{\mathop{\widehat{\otimes}}}
...
\todo[inline]{Add QED tombstones to theorem statements that we don't plan to prove in the main.}
