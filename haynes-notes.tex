...
We seek to prove the following properties of the Adams operations:
...
\end{itemize}
%\end{thm}
\noindent\textbf{I am unsure how this ties in logically with the next two chapters. How do we know that what we constructed here coincides with what we construct there? Do the properties above characterise the Adams operations on $K(X)$? I should ask somebody who knows.}
