...
\tikzset{    
    wavy/.style={/tikz/decorate,/tikz/decoration={
        ...
        post=lineto, post length=2\pgflinewidth,
        pre=lineto, pre length=2\pgflinewidth
    }}
}
...
\newcommand{\K}{K}
\renewcommand{\Ktwee}{\widetilde{\K}\vphantom{\K}}
\newcommand{\J}{J}
\renewcommand{\Jtwee}{\widetilde{\J}\vphantom{\J}}
\newcommand{\KO}{KO}
\newcommand{\KOtwee}{\widetilde{\KO}\vphantom{\KO}}
\newcommand{\Sph}{Sph}
\newcommand{\Sphtwee}{\widetilde{\Sph}\vphantom{\Sph}} % Just used in adams-conjecture
